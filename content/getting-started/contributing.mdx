---
title: Contributing to Nature UI
description:
  "Thanks for being interested in contributing! We want contributing to Nature
...
will get you up and running to contribute to the Nature UI docsite:

1. Fork the repo (click the <kbd>Fork</kbd> button at the top right of
   [this page](https://github.com/nature-ui/nature-ui-docs))
...
> If you run into any issues, kindly reach out to the Nature UI React team here:
> https://discord.gg/nature-ui
...
When a new version of `@nature-ui/react` has been released, here's what you need
...
- Run `pnpm changelog:gen` to fetch the most recent changelog from the
  [main repository](https://github.com/nature-ui/nature-ui)
...
3. Make and commit your changes following the
   [commit convention](https://github.com/nature-ui/nature-ui-docs/blob/main/CONTRIBUTING.md#commit-convention).
...
https://discord.gg/nature-ui. We would love to support you any way we can.
...
Visit
https://github.com/settings/tokens/new?description=Nature+website+development to
...
By contributing your code to the nature-ui-docs GitHub repository, you agree to
