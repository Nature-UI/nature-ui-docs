...
description: Popover is a non-modal dialog that floats around a trigger. It is used to display contextual information to the user, and should be paired with a
  ...
  return (
    <Stack col>
      ...
      <Stack row className="mt-4">
        <Button size="sm" color="gray-600" variant="outline" onClick={onCancel}>
          Cancel
        </Button>
        <Button size="sm" isDisabled color="purple-500">
          Save
        </Button>
      </Stack>
    </Stack>
...
function ControlledUsage() {
  ...
  return (
    <>
      ...
      >
        <PopoverTrigger>
          <Button color="pink-500">Popover Target</Button>
        </PopoverTrigger>
        <PopoverContent>
          ...
          <PopoverFooter className="justify-end flex">
            <Stack row>
              <Button size="sm" color="gray-500" variant="outline">
                Cancel
              </Button>
