...
```jsx
<Stack spacing={10} row>
  <Checkbox color='bg-purple-500' defaultIsChecked>
    Checkbox
  </Checkbox>
  <Checkbox color='bg-green-500' defaultIsChecked>
    Checkbox
  </Checkbox>
</Stack>
```
...
```jsx
<Stack spacing={10} row>
  <Checkbox size='sm' color='bg-purple-500'>
    Checkbox
  </Checkbox>
  <Checkbox size='md' color='bg-green-500' defaultIsChecked>
    Checkbox
  </Checkbox>
  <Checkbox size='lg' color='bg-orange-500' defaultIsChecked>
    Checkbox
  </Checkbox>
</Stack>
```
...
```jsx
<CheckboxGroup color='bg-green-600' defaultValue={['naruto', 'kakashi']}>
  <Stack row>
