...
<Stack spacing={10} row>
  ...
  <Checkbox size='md' color='bg-green-500 hover:bg-purple-700' defaultIsChecked>
    Checkbox
  </Checkbox>
  <Checkbox size='lg' color='bg-orange-500 hover:bg-orange-700' defaultIsChecked>
    Checkbox
  </Checkbox>
</Stack>
```
...
```jsx
<CheckboxGroup color='bg-green-600 hover:bg-green-700' defaultValue={['naruto', 'kakashi']}>
  <Stack row>
