...
You can add `indicatorClassName` prop to any progress bar to apply any color that
...
| ------------------ | ---------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------- |
| indicatorClassName | `string`                                 | `bg-blue-500` | Determines the fill color of the progress bar                                                           |
